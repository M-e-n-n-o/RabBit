...
//#include "../Game.h"
//
//LPCWSTR g_szAppName = L"RabBit Engine";
//
//std::unique_ptr<Game> g_game;
//
//// Entry point
//
//int TempWindow::win(HINSTANCE hInstance, int nCmdShow)
//{
...
//
//// Windows procedure
//LRESULT CALLBACK TempWindow::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
//{
...
//
//// Exit helper
//void TempWindow::ExitGame() noexcept
//{
//    PostQuitMessage(0);
//}
