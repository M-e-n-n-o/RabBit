...
namespace RB::Graphics::Native
{
	...
	void CommandList::TransitionResourceBarrier(ID3D12Resource* resource, D3D12_RESOURCE_STATES to, uint32_t subresource)
	{
		g_ResourceStateManager->TransitionResource(resource, to, subresource);
	}
