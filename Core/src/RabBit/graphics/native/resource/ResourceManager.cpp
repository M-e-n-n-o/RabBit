...
namespace RB::Graphics::Native
{
	...
	SimpleDescriptorHeap::SimpleDescriptorHeap(const wchar_t* name, D3D12_DESCRIPTOR_HEAP_TYPE type, uint32_t max_number_descriptors, bool shader_visible)
	...
	SimpleDescriptorHeap::~SimpleDescriptorHeap()
	{
	}
	
	D3D12_CPU_DESCRIPTOR_HANDLE SimpleDescriptorHeap::GetCpuHandle(uint32_t offset)
	{
	...
	D3D12_GPU_DESCRIPTOR_HANDLE SimpleDescriptorHeap::GetGpuHandle(uint32_t offset)
	{
